<template>
	<view class="content">
		<view class="uni-list">
			<view class="uni-list-cell" style="height: 80upx;">
				...
				<view class="uni-list-cell-db">
					<input class="uni-input" type="number" disabled ='true'  v-model="barcode" placeholder="无法扫描可手动输入并点击查询"></input>
				</view>
			</view>
			<view class="uni-list-cell" style="height: 80upx;">
				<view class="uni-list-cell-left">
		...
		<view v-if="showFlag"><button class="btn" @tap="scanCode" type="primary" style="background: #FFAC60;">扫码</button></view> 
	</view>
</template>
