	...
	<view class="content">
		<view class="uni-list">
			<view class="uni-list-cell" style="height: 80upx;">
				...
				<view class="uni-list-cell-db">
					<input class="uni-input" type="text"  disabled ='true' v-model="sl" style="color: red;font-size: 24px;"></input>
				</view>
			</view>
			<view class="uni-list-cell" style="height: 80upx;">
				<view class="uni-list-cell-left">
				...
				<view class="uni-list-cell-db">
					<input class="uni-input" type="number" @focus="focus" placeholder="无法扫描可手动输入并点击查询" v-model="userid"></input>
