						    ...
						    <view class="uni-list-cell">
						        <view class="uni-triplex-row">
						            <view class="uni-triplex-left" style="width: 100%;">
						                <text class="uni-title uni-ellipsis">员工:{{item1.uname}}<text class="kg"></text>货号:{{item1.huohao}}<text class="kg"></text>工序:{{item1.worktype}}</text>
	...
	export default {
		...
		methods: {
			initDate(){
				setTimeout(() =>{
					uni.request({
						url:`https://${this.dk}/gongziUidHuohao.aspx`,
						method: 'GET',
						data: {			
							dates:this.dates,
							datee:this.datee,
