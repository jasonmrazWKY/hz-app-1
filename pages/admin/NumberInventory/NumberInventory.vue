						    ...
						    <view class="uni-list-cell">
						        <view class="uni-triplex-row">
						            <view class="uni-triplex-left" style="width: 100%;">
						                ...
						                <text class="uni-text">包数:{{item1.bs}}<text class="kg"></text>数量:{{item1.sl}}</text>
						            </view>
						        </view>
						    </view>
						</block>
...
<script>
	...
	export default {
		...
		methods: {
			initDate(){
				uni.request({
					url:`https://${this.dk}/getHuohaoKc.aspx`,
					method: 'GET',
					data: {
						dates:this.dates,
						datee:this.datee,
...
.box{background: #FFFFFF;margin-bottom: 24upx;display: flex;position: fixed;width: 100%;height: 72upx;z-index: 99;/* #ifdef H5 */
	top: 89upx;
/* #endif */}
.section {position: relative;background: #FFFFFF; width: 50%;margin-left: 30upx;}
...
.dw{position: fixed;bottom: 0;background: #FFFFFF;width: 100%;z-index: 10;}
...
.uni-triplex-row{padding: 0;}
.uni-common-mt{margin-top: 0;}
.uni-padding-wrap {width: 100%;padding:0;}
.uni-list-cell::after {
    position: absolute;
    z-index: 3;
    right: 0;
