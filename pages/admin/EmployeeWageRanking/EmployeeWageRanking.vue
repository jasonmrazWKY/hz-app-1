<template>
	<view class="content">
		<view class="box" style="margin-bottom: 0;">
			...
			<button size='mini' style="right: 230upx;" @tap="onpeDetailed">查询</button>
			<button size='mini' style="right: 90upx;" @tap="onpeIfon">更多</button>
		</view>
		...
		<view class="box1" style="float:left;width:100%;">
	...
	export default {
		...
		methods: {
			initData(){
				setTimeout(() =>{
					uni.request({				
						url:`https://${this.dk}/gongziJeOrder.aspx`,
						method: 'GET',
						data: {				
							dates:this.dates,
							datee:this.datee,
...
.box{background: #FFFFFF;padding: 0 40upx;margin-bottom: 24upx;display: flex;position: fixed;top: 0;width: 100%;}
...
button{position: absolute;top: 10upx;background: rgb(255, 172, 96);color: #FFFFFF;z-index: 99;right: 0;}	
